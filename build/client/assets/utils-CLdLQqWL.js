...
const ne = '-',
  ...
  Fe = (e) => ({ cache: Le(e.cacheSize), parseClassName: Be(e), sortModifiers: je(e), ...Pe(e) }),
  Oe = /\s+/,
  Ue = (e, n) => {
    const {
        parseClassName: r,
...
function We(e, ...n) {
  let r,
    ...
    m = l;
  function l(p) {
    const b = n.reduce((h, C) => C(h), e());
    return ((r = Fe(b)), (o = r.cache.get), (i = r.cache.set), (m = u), u(p));
  }
  function u(p) {
    const b = o(p);
    if (b) return b;
...
const f = (e) => {
  ...
  He = /^(rgba?|hsla?|hwb|(ok)?(lab|lch)|color-mix)\(.+\)$/,
  ...
  lo = () => {
    ...
    return {
      ...
      classGroups: {
        ...
        'outline-w': [{ outline: ['', d, _, P] }],
        'outline-color': [{ outline: a() }],
        shadow: [{ shadow: ['', 'none', h, X, K] }],
        'shadow-color': [{ shadow: a() }],
        'inset-shadow': [{ 'inset-shadow': ['none', C, X, K] }],
        ...
        'text-shadow': [{ 'text-shadow': ['none', j, X, K] }],
        ...
        'drop-shadow': [{ 'drop-shadow': ['', 'none', F, X, K] }],
...
function po(e) {
  ...
  return parseFloat((e / Math.pow(n, o)).toFixed(2)) + ' ' + r[o];
}
const uo = () => crypto.randomUUID();
export { mo as c, po as f, uo as g };
