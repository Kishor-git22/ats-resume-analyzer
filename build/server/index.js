...
import { ServerRouter, UNSAFE_withComponentProps, Outlet, UNSAFE_withErrorBoundaryProps, isRouteErrorResponse, Meta, Links, ScrollRestoration, Scripts, useLocation, useNavigate, Link, useParams } from "react-router";
...
const home = UNSAFE_withComponentProps(function Home() {
  ...
  return /* @__PURE__ */ jsxs("main", {
    ...
    children: [/* @__PURE__ */ jsx(Navbar, {}), /* @__PURE__ */ jsxs("section", {
      className: "main-section grid grid-cols-1 md:grid-cols-2 max-md:pt-5 gap-8 items-start md:items-center",
      children: [/* @__PURE__ */ jsxs("div", {
        ...
        children: /* @__PURE__ */ jsx("div", {
          className: "bg-gradient-to-r  from-purple-500/20 via-pink-500/10 to-blue-500/20 p-6 max-md:p-4 rounded-3xl",
          children: /* @__PURE__ */ jsx("div", {
            ref: sliderRef,
            ...
            children: /* @__PURE__ */ jsx("div", {
              className: "flex items-stretch gap-6 py-6 px-6 max-md:gap-4 max-md:py-4 max-md:px-4",
              children: !loadingResumes && (resumes == null ? void 0 : resumes.length) > 0 ? /* @__PURE__ */ jsxs(Fragment, {
                children: [resumes.map((resume2) => /* @__PURE__ */ jsx("div", {
                ...
                }, `a-${resume2.id}`)), resumes.map((resume2) => /* @__PURE__ */ jsx("div", {
                  className: "\n                    min-w-[280px] max-md:min-w-[240px] flex-shrink-0 rounded-xl bg-white shadow-md p-4\n                    transition-transform duration-500 hover:-translate-y-2 hover:scale-[1.05]\n                  ",
                  children: /* @__PURE__ */ jsx(ResumeCard, {
                    resume: resume2
                  })
                ...
                className: "flex flex-col items-center justify-center mt-10 gap-4 w-full max-md:mt-6",
...
const Upload = () => {
  ...
  return /* @__PURE__ */ jsxs("main", {
    ...
    children: [/* @__PURE__ */ jsx(Navbar, {}), /* @__PURE__ */ jsx("section", {
      ...
      children: /* @__PURE__ */ jsxs("div", {
        className: "page-heading flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8 lg:gap-16 xl:gap-40",
        children: [/* @__PURE__ */ jsxs("div", {
