...
const ErrorBoundary = UNSAFE_withErrorBoundaryProps(function ErrorBoundary2({ error }) {
  let message = 'Oops!';
      ...
      /* @__PURE__ */ jsxs('div', {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx('div', {
            ...
            children: /* @__PURE__ */ jsx(ScoreCircle, { score: feedback.overallScore }),
          }),
        ],
      }),
      resumeUrl &&
        /* @__PURE__ */ jsx('div', {
          ...
          children: /* @__PURE__ */ jsx('div', {
            ...
            children: /* @__PURE__ */ jsx('img', {
              src: resumeUrl,
              alt: 'resume',
              className: 'w-full  h-[100px] max-sm:h-[200px] object-cover object-top',
            }),
          }),
        }),
    ],
...
const home = UNSAFE_withComponentProps(function Home() {
  const { auth: auth2, kv } = usePuterStore();
  const navigate = useNavigate();
  ...
  useEffect(() => {
    const loadResumes = async () => {
      ...
      const parsedResumes =
        resumes2 == null ? void 0 : resumes2.map((resume2) => JSON.parse(resume2.value));
  ...
  return /* @__PURE__ */ jsxs('main', {
    className: "bg-[url('/images/bg-main.svg')] bg-cover max-md:px-5",
    children: [
      /* @__PURE__ */ jsx(Navbar, {}),
      /* @__PURE__ */ jsxs('section', {
        className:
          'main-section grid grid-cols-1 md:grid-cols-2 max-md:pt-5 gap-8 items-start md:items-center',
        children: [
          /* @__PURE__ */ jsxs('div', {
            className: 'page-heading md:sticky md:top-5 order-1 md:order-2',
            children: [
              /* @__PURE__ */ jsx('h1', {
                className: 'text-2xl md:text-lg max-md:text-xl font-bold text-gradient',
                children: 'Track Your Applications & Resume Ratings',
              }),
              !loadingResumes && (resumes == null ? void 0 : resumes.length) === 0
                ? /* @__PURE__ */ jsx('h2', {
          ...
          /* @__PURE__ */ jsx('div', {
            className: 'order-2 md:order-2 max-md:mx-2',
            children: /* @__PURE__ */ jsx('div', {
              className:
                'bg-gradient-to-r  from-purple-500/20 via-pink-500/10 to-blue-500/20 p-6 max-md:p-4 rounded-3xl',
              children: /* @__PURE__ */ jsx('div', {
                ref: sliderRef,
                className:
                ...
                children: /* @__PURE__ */ jsx('div', {
                  className:
                    'flex items-stretch gap-6 py-6 px-6 max-md:gap-4 max-md:py-4 max-md:px-4',
                  children:
                    !loadingResumes && (resumes == null ? void 0 : resumes.length) > 0
                            ...
                            resumes.map((resume2) =>
                              /* @__PURE__ */ jsx(
                                'div',
                                {
                                  ...
                                  children: /* @__PURE__ */ jsx(ResumeCard, {
                                    resume: resume2,
                                  }),
                                },
                                `a-${resume2.id}`
                      ...
                      : loadingResumes
                        ...
                        : /* @__PURE__ */ jsxs('div', {
                            className:
                              'flex flex-col items-center justify-center mt-10 gap-4 w-full max-md:mt-6',
                            children: [
                              /* @__PURE__ */ jsx('h2', {
                              ...
                              /* @__PURE__ */ jsx(Link, {
                                to: '/upload',
                                className:
                                  'primary-button w-fit text-xl max-md:text-lg font-semibold',
...
const Auth = () => {
  const { isLoading, auth: auth2 } = usePuterStore();
  const location = useLocation();
          ...
          /* @__PURE__ */ jsx('div', {
            children: isLoading
              ...
              : /* @__PURE__ */ jsx(Fragment, {
                  children: auth2.isAuthenticated
                    ? /* @__PURE__ */ jsx('button', {
          ...
          children: file
            ...
            : /* @__PURE__ */ jsxs('div', {
                children: [
                  ...
                  /* @__PURE__ */ jsxs('p', {
                    className: 'text-base text-gray-500',
                    children: ['PDF (max ', formatSize(maxFileSize), ')'],
                  }),
                ],
              }),
        }),
...
const Upload = () => {
  const { auth: auth2, isLoading, fs, ai, kv } = usePuterStore();
  const navigate = useNavigate();
  ...
  const handleAnalyze = async ({ companyName, jobTitle, jobDescription, file: file2 }) => {
...
const ScoreBadge$1 = ({ score }) => {
  ...
  return /* @__PURE__ */ jsx('div', {
    ...
    children: /* @__PURE__ */ jsx('p', { className: 'text-sm font-medium', children: badgeText }),
  });
};
...
const AccordionHeader = ({ itemId, children, className = '', icon, iconPosition = 'right' }) => {
  const { toggleItem, isItemActive } = useAccordion();
  const isActive = isItemActive(itemId);
  const defaultIcon = /* @__PURE__ */ jsx('svg', {
    ...
    children: /* @__PURE__ */ jsxs(Accordion, {
      children: [
        /* @__PURE__ */ jsxs(AccordionItem, {
          id: 'tone-style',
          children: [
            /* @__PURE__ */ jsx(AccordionHeader, {
              itemId: 'tone-style',
              children: /* @__PURE__ */ jsx(CategoryHeader, {
                title: 'Tone & Style',
            ...
            /* @__PURE__ */ jsx(AccordionContent, {
              itemId: 'tone-style',
              children: /* @__PURE__ */ jsx(CategoryContent, { tips: feedback.toneAndStyle.tips }),
            }),
          ],
        }),
        /* @__PURE__ */ jsxs(AccordionItem, {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx(AccordionContent, {
              itemId: 'content',
              children: /* @__PURE__ */ jsx(CategoryContent, { tips: feedback.content.tips }),
            }),
          ],
        }),
        /* @__PURE__ */ jsxs(AccordionItem, {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx(AccordionContent, {
              itemId: 'structure',
              children: /* @__PURE__ */ jsx(CategoryContent, { tips: feedback.structure.tips }),
            }),
          ],
        }),
        /* @__PURE__ */ jsxs(AccordionItem, {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx(AccordionContent, {
              itemId: 'skills',
              children: /* @__PURE__ */ jsx(CategoryContent, { tips: feedback.skills.tips }),
            }),
          ],
        }),
      ],
...
const Resume = () => {
  const { auth: auth2, isLoading, fs, kv } = usePuterStore();
  const { id } = useParams();
...
const WipeApp = () => {
  var _a;
  const { auth: auth2, isLoading, error, clearError, fs, ai, kv } = usePuterStore();
  const navigate = useNavigate();
  ...
  return /* @__PURE__ */ jsxs('div', {
    children: [
      'Authenticated as: ',
      (_a = auth2.user) == null ? void 0 : _a.username,
      /* @__PURE__ */ jsx('div', {
...
const serverManifest = {
  entry: {
    module: '/assets/entry.client-DQFzWzMJ.js',
    imports: ['/assets/chunk-QMGIS6GS-DX0VMMAr.js'],
    css: [],
  },
  routes: {
    root: {
      ...
      module: '/assets/root-BDAueShu.js',
      imports: ['/assets/chunk-QMGIS6GS-DX0VMMAr.js', '/assets/puter-N-LIF3ap.js'],
      css: ['/assets/root-CAFy8pHV.css'],
    ...
    'routes/home': {
      ...
      module: '/assets/home-BBTnsjBx.js',
      imports: [
        '/assets/chunk-QMGIS6GS-DX0VMMAr.js',
        '/assets/Navbar-iwqjtJz1.js',
        '/assets/puter-N-LIF3ap.js',
      ],
      css: [],
      clientActionModule: void 0,
      clientLoaderModule: void 0,
    ...
    'routes/auth': {
      ...
      hasClientMiddleware: false,
      hasErrorBoundary: false,
      module: '/assets/auth-BOzBCEXo.js',
      imports: ['/assets/chunk-QMGIS6GS-DX0VMMAr.js', '/assets/puter-N-LIF3ap.js'],
      css: [],
      clientActionModule: void 0,
      clientLoaderModule: void 0,
    ...
    'routes/upload': {
      ...
      hasClientMiddleware: false,
      hasErrorBoundary: false,
      module: '/assets/upload-B4-UmAHR.js',
      imports: [
        '/assets/chunk-QMGIS6GS-DX0VMMAr.js',
        '/assets/Navbar-iwqjtJz1.js',
        '/assets/utils-CLdLQqWL.js',
        '/assets/puter-N-LIF3ap.js',
      ],
      css: [],
      clientActionModule: void 0,
    ...
    'routes/resume': {
      ...
      hasClientMiddleware: false,
      hasErrorBoundary: false,
      module: '/assets/resume-CKRDyHbU.js',
      imports: [
        '/assets/chunk-QMGIS6GS-DX0VMMAr.js',
        '/assets/puter-N-LIF3ap.js',
        '/assets/utils-CLdLQqWL.js',
    ...
    'routes/wipe': {
      ...
      hasClientMiddleware: false,
      hasErrorBoundary: false,
      module: '/assets/wipe-RWU7PbBx.js',
      imports: ['/assets/chunk-QMGIS6GS-DX0VMMAr.js', '/assets/puter-N-LIF3ap.js'],
      css: [],
      clientActionModule: void 0,
      clientLoaderModule: void 0,
  ...
  url: '/assets/manifest-96b2c345.js',
  version: '96b2c345',
  sri: void 0,
};
